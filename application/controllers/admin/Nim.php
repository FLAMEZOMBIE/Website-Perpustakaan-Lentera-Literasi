...
class Nim extends CI_Controller {
    ...
    public function index()
    {
        ...
        {
            /*layout*/  
            $data['title']='Daftar Nim Mahasiswa';
            $data['pointer']="Nim";
            $data['classicon']="fa fa-book";
            $data['main_bread']="Data Mahasiswa";
            $data['sub_bread']="Daftar Nim";
            $data['desc']="Data Master Nim, Menampilkan data Nim";
        ...
        public function create()
    {
        ...
        {   
                ...
                {
                    $data['title']='Tambah Nim';
                    $data['pointer']="Nim";
                    $data['classicon']="fa fa-book";
                    $data['main_bread']="Data Nim";
                    $data['sub_bread']="Tambah Nim";
                    $data['desc']="form untuk Input data Nim";
    ...
    { 
        ...
        {       
                ...
                if($this->form_validation->run()==FALSE)
                {
                    ...
                    $data['main_bread']="Data Kelas";
                    $data['sub_bread']="Edit Kelas";
                    $data['desc']="Form untuk melakukan edit Nim";
