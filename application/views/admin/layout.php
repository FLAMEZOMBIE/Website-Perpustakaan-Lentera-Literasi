...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>assets2/img/logo.png" class="logo">
      ...
      <span class="logo-lg"><b>Lentera</b>Literasi</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logotelkom.png" alt="" srcset="" width="47px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="#">Lentera Literasi</a>.</strong> 
  </footer>
